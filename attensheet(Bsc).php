...
$student=mysqli_query($db,"SELECT student_name FROM student_bsc");
...
<table border="1" cellspacing="0" cellpadding="5" width="100%" class="table table-striped">
    ...
    text-align: center;
    padding: 20px 0; text-shadow:2px 3px 7px black; ">Attendance Tracker <br>ATTENDANCE OF BSc(CS) </h1>
